![BPulsa](raw/bpulsa_top.png?raw=true)

# BPulsa

<a href='https://play.google.com/store/apps/details?id=com.bonuspulsa.bpulsa&pcampaignid=MKT-Other-global-all-co-prtnr-py-PartBadge-Mar2515-1'><img alt='Get it on Google Play' src='https://play.google.com/intl/en_us/badges/images/generic/en_badge_web_generic.png' height=90px/></a>

The goal of this project is to provide an ultimate collection of real world app's UIs.
While I built BPulsa for my own needs, it is also intented to showcase good app structure and a clean, well-organized Flutter codebase.
...
This project is open to all kinds of contribution in all of its categories. **Together, we can make it the ultimate BPulsa available for free, for everyone, forever.**
